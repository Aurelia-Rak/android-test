...
import com.evaneos.evaneostest.viewmodels.DestinationDetail_WebViewModel

class DestinationDetail_WebView : AppCompatActivity() {
    private var webView: WebView? = null
    private lateinit var mDest_WebView: DestinationDetail_WebViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_destinationdetail_webview)
        ...
        ).get(DestinationDetail_WebViewModel::class.java)
